...
This game is self-contained in a single HTML file (index.html) and requires no external libraries or web servers (it uses synthetic audio and native Canvas API).

### **Step-by-Step Instructions**

1. **Save the Code:** Copy the entire content of the game and save it into a plain text file named index.html. Ensure the file extension is .html.  
